...
<head>
    <meta charset="UTF-8">
    <title>Confirm your new phone number</title>
</head>
        ...
        <tr>
            <td>
                ...
                <p style="font-size: 14px; color: #4b5563; margin-bottom: 16px;">
                    Hi {{ $user->name }}, you requested to change the phone number associated with your Disaster Preparedness Training &amp; Simulation account.
                </p>
                <p style="font-size: 14px; color: #4b5563; margin-bottom: 16px;">
                    New phone number: <strong>{{ $newPhone }}</strong>
                </p>
                <p style="font-size: 14px; color: #4b5563; margin-bottom: 20px;">
                    To confirm this change, please click the button below:
                </p>
                <p style="text-align: center; margin-bottom: 20px;">
                    <a href="{{ $confirmUrl }}" style="display: inline-block; padding: 10px 18px; background-color: #059669; color: #ffffff; border-radius: 999px; text-decoration: none; font-size: 14px;">
